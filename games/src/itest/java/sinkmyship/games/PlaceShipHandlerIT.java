...
public class PlaceShipHandlerIT extends IntegrationTest {
    ...
    public void handle() throws Exception {
        ...
        CreateGame create = new CreateGame("p1", "p2", UUID.randomUUID().toString(), 10, 10);
        Response creationResponse = post(create, url(awsApiId, "games/CreateGame"));
        ...
        Response response = put(cmd, url(awsApiId, "games/PlaceShip"));
